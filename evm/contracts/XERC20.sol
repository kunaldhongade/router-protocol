...
/// utilise Router CrossTalk for making omni-chain tokens
contract XERC20 is ERC20, IDapp {
  ...
  constructor(
    ...
    uint256 amount
  ) ERC20("OMNICHAIN Token", "OMNI") {

    name["arbitrum"]="421614";
    name["polygon"]="80002"; // amoy testnet
    gateway["arbitrum"]=0x4b7ff2fae6b514a7943d360e01790dc1dfaf6736;
    gateway["polygon"]=0x778a1f43459a05accd8b57007119f103c249f929;
    ChainName=chainName;
